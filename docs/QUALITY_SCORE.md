...
| Testing | C | Host-plane smoke coverage now includes Go tests plus real Firecracker harness validation for sandbox lifecycle and a minimal guest process-api. | Add repeatable CI or scripted harness checks once the runtime stabilizes. |
