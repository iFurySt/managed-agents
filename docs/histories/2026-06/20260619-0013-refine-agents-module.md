...
The follow-up keeps the table density change in the shared CDS layer because Agents, Sessions, Deployments, Environments, Vaults, Files, and other management lists share the same Claude table token.
