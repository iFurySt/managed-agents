...
function Sidebar() {
  ...
  if (collapsed) {
    return (
      <aside aria-label="Main navigation" className="sticky top-0 flex h-screen w-64 shrink-0 flex-col border-r-[0.5px] border-line bg-[#f9f9f7] p-0 shadow-[inset_-4px_0px_6px_-4px_rgba(0,0,0,0.04)]">
  ...
  return (
    <aside aria-label="Main navigation" className="sticky top-0 flex h-screen w-64 shrink-0 flex-col border-r-[0.5px] border-line bg-[#f9f9f7] p-3 shadow-[inset_-4px_0px_6px_-4px_rgba(0,0,0,0.04)]">
      ...
      <nav className="flex min-h-0 flex-1 flex-col gap-1 overflow-y-auto pb-0">
        ...
        />
        <Group icon={<SidebarGlyph glyph="" />} label="Analytics" items={["Usage", "Caching", "Rate limits", "Cost", "Logs"]} testId="sidebar-section-analytics" />
        <Group icon={<SidebarGlyph glyph="" />} label="Claude Code" items={["Usage", "Settings"]} testId="sidebar-section-claude-code" />
...
function CreateAgentDialog({
  ...
  return (
    ...
    >
      <div className="flex h-[calc(65vh+71px)] max-h-[calc(100dvh-112px)] flex-col overflow-y-auto px-6 pb-6 pt-[10.5px]">
        <button
